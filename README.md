...
Adds a brightness/contrast button to the toolbar. Recognizes appropriate range via filename and filepath - e.g., filename containing `OuterMask` automatically adjusts to 0-1. Two steps to install:  
